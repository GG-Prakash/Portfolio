      ...
      <div className="flex flex-col md:flex-row gap-10  max-w-6xl mx-auto  ">
        ...
        <div className="w-full md:w-2/6  items-start gap-8">
          <div>
            ...
            <div className="w-72 h-42 bg-gray-900/20 rounded-xl border border-gray-600/30 shadow-md">
            ...
            <div >
              <span><a
                ...
                className="px-2 py-3 text-black rounded-md hover:bg-blue-400 transition-colors duration-300"
              >
                Download Resume
              </a>
              </span>
